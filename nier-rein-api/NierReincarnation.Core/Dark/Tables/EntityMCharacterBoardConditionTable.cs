...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMCharacterBoardConditionTable : TableBase<EntityMCharacterBoardCondition>
    {
        ...
        public RangeView<EntityMCharacterBoardCondition> FindRangeByCharacterBoardConditionGroupIdAndGroupIndex(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMBattleActorSkillAiGroupTable : TableBase<EntityMBattleActorSkillAiGroup>
    {
        ...
        public RangeView<EntityMBattleActorSkillAiGroup> FindRangeByBattleActorSkillAiGroupIdAndPriority(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

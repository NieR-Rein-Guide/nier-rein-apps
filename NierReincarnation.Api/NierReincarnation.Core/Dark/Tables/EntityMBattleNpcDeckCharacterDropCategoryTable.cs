...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMBattleNpcDeckCharacterDropCategoryTable : TableBase<EntityMBattleNpcDeckCharacterDropCategory>
    {
        ...
        public EntityMBattleNpcDeckCharacterDropCategory FindByBattleNpcIdAndBattleNpcDeckCharacterUuid(ValueTuple<long, string> key) { return FindUniqueCore(data, primaryIndexSelector, Comparer<(long,string)>.Default, key); }

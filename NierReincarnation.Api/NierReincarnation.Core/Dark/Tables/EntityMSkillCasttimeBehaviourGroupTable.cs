...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMSkillCasttimeBehaviourGroupTable : TableBase<EntityMSkillCasttimeBehaviourGroup>
    {
        ...
        public RangeView<EntityMSkillCasttimeBehaviourGroup> FindRangeBySkillCasttimeBehaviourGroupIdAndSkillCasttimeBehaviourIndex(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

...
{
    internal class CompanionSelectionDialog : FilterItemDialog<DataOutgameCompanionInfo>
    {
        ...
        private static bool IsValidFilter(DataOutgameCompanionInfo companionInfo, IList<AttributeType> attributeFilter)
        {

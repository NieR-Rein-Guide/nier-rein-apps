...
{
    public static readonly int kFirstRebirthStep;
    public static readonly int kRebirthStepDelta = 1;
    public static readonly int kMaxMaterialCount = 5;
    public static readonly int kInvalidCharacterRebirthStepGroupId;
    public static readonly int kDefaultLevelLimitUpValue;

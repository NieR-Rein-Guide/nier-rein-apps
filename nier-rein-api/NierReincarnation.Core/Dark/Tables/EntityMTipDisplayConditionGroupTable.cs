...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMTipDisplayConditionGroupTable : TableBase<EntityMTipDisplayConditionGroup>
    {
        ...
        public RangeView<EntityMTipDisplayConditionGroup> FindRangeByTipDisplayConditionGroupIdAndSortOrder(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

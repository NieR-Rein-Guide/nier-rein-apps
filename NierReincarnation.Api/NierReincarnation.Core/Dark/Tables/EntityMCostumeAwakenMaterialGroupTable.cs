...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMCostumeAwakenMaterialGroupTable : TableBase<EntityMCostumeAwakenMaterialGroup>
    {
        ...
        public RangeView<EntityMCostumeAwakenMaterialGroup> FindRangeByCostumeAwakenMaterialGroupIdAndMaterialId(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMBattleEventGroupTable : TableBase<EntityMBattleEventGroup>
    {
        ...
        public RangeView<EntityMBattleEventGroup> FindRangeByBattleEventGroupIdAndBattleEventId(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

...
{
    class ClearAllEndDailyDialog : Modal
    {
        ...
        private ComboBox<DataDeckInfo> deckBox;
        ...
        {
            countLabel.Caption = string.Format(LocalizationResources.ClearQuestsHeader, count, _quests.Count);
        }
    }
}

...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMSkillRemoveAbnormalTargetAbnormalGroupTable : TableBase<EntityMSkillRemoveAbnormalTargetAbnormalGroup>
    {
        ...
        public RangeView<EntityMSkillRemoveAbnormalTargetAbnormalGroup> FindRangeBySkillRemoveAbnormalTargetAbnormalGroupIdAndSkillRemoveAbnormalTargetAbnormalGroupIndex(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

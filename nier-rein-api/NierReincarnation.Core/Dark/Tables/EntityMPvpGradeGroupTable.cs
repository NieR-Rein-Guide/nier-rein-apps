...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMPvpGradeGroupTable : TableBase<EntityMPvpGradeGroup>
    {
        ...
        public RangeView<EntityMPvpGradeGroup> FindRangeByPvpGradeGroupIdAndPvpGradeId(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

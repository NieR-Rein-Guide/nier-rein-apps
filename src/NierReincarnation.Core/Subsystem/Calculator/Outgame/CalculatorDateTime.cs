...
public static class CalculatorDateTime
{
    ...
    public static int kUnixTimeSecond = 1000;

    private const long kSecondsToMillisecondsOffset = 1000;
    private const int TimeDifferenceYear = 365;
    private const int MinDays = 0;
    public static readonly int DayHours = 24;
    private const int MinHours = 0;
    private const int LimitMinutes = 59;
    private const int MinMinutes = 0;
    private const int MaxSeconds = 59;
    private const int MinSeconds = 0;
    private const double kBorderMilliseconds = 1;

...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMCostumeDefaultSkillLotteryGroupTable : TableBase<EntityMCostumeDefaultSkillLotteryGroup>
    {
        ...
        public RangeView<EntityMCostumeDefaultSkillLotteryGroup> FindRangeByCostumeDefaultSkillLotteryGroupIdAndSkillDetailId(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

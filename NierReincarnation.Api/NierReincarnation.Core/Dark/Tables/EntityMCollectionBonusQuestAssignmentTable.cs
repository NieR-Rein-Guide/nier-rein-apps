...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMCollectionBonusQuestAssignmentTable : TableBase<EntityMCollectionBonusQuestAssignment>
    {
        ...
        public EntityMCollectionBonusQuestAssignment FindByCollectionBonusQuestAssignmentId(int key) { return FindUniqueCore(data, primaryIndexSelector, Comparer<int>.Default, key); }

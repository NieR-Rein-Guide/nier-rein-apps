...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMQuestSceneChoiceWeaponEffectGroupTable : TableBase<EntityMQuestSceneChoiceWeaponEffectGroup>
    {
        ...
        public RangeView<EntityMQuestSceneChoiceWeaponEffectGroup> FindByWeaponId(int key) { return FindManyCore(data, secondaryIndexSelector, Comparer<int>.Default, key); }

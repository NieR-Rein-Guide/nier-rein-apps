...
namespace NierReincarnation.Core.Dark
{
    ...
    public class EntityMCompanion
    {
        ...
        public AttributeType AttributeType { get; set; } // 0x14
        [Key(2)] // RVA: 0x1DDB430 Offset: 0x1DDB430 VA: 0x1DDB430
        public int CompanionCategoryType { get; set; } // 0x18
        [Key(3)] // RVA: 0x1DDB444 Offset: 0x1DDB444 VA: 0x1DDB444
        public int CompanionBaseStatusId { get; set; } // 0x1C
        ...
        public int SkillId { get; set; } // 0x24
        [Key(6)] // RVA: 0x1DDB480 Offset: 0x1DDB480 VA: 0x1DDB480
        public int CompanionAbilityGroupId { get; set; } // 0x28
        [Key(7)] // RVA: 0x1DDB494 Offset: 0x1DDB494 VA: 0x1DDB494
        public int ActorId { get; set; } // 0x2C
        ...
        public int CharacterMoverBattleActorAiId { get; set; } // 0x38
	}
}

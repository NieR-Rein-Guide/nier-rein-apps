...
{
    internal class BigHuntDialog : Modal
    {
        ...
        private readonly ComboBox<SubjugationGrade> grades;
        ...
        private static void InitializeGrades(ComboBox<SubjugationGrade> grades)
        {

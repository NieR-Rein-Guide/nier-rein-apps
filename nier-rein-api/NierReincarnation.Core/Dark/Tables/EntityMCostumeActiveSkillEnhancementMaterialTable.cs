...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMCostumeActiveSkillEnhancementMaterialTable : TableBase<EntityMCostumeActiveSkillEnhancementMaterial>
    {
        ...
        public RangeView<EntityMCostumeActiveSkillEnhancementMaterial> FindRangeByCostumeActiveSkillEnhancementMaterialIdAndSkillLevelAndMaterialId(ValueTuple<int, int, int> min, ValueTuple<int, int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int,int)>.Default, min, max, ascendant); }

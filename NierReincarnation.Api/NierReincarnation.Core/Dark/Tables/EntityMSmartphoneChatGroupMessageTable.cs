...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMSmartphoneChatGroupMessageTable : TableBase<EntityMSmartphoneChatGroupMessage>
    {
        ...
        public RangeView<EntityMSmartphoneChatGroupMessage> FindRangeBySmartphoneChatGroupIdAndSortOrder(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

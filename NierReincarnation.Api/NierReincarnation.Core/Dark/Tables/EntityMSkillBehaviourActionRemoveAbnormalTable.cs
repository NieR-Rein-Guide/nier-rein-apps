...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMSkillBehaviourActionRemoveAbnormalTable : TableBase<EntityMSkillBehaviourActionRemoveAbnormal>
    {
        ...
        public EntityMSkillBehaviourActionRemoveAbnormal FindBySkillBehaviourActionId(int key) { return FindUniqueCore(data, primaryIndexSelector, Comparer<int>.Default, key); }

...
public class ExportCharacterStoriesMenuCommand : AbstractMenuCommand
{
    ...
    private static TextMenu BuildStoriesMenu()
    {
        ...
        int i = 1;
        foreach (var darkEventQuestChapter in MasterDb.EntityMEventQuestChapterTable.All.Where(x => x.EventQuestType == EventQuestType.CHARACTER).OrderBy(x => x.StartDatetime))
        {

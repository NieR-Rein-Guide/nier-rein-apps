...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMSkillAbnormalLifetimeBehaviourReceiveDamageCountTable : TableBase<EntityMSkillAbnormalLifetimeBehaviourReceiveDamageCount>
    {
        ...
        public EntityMSkillAbnormalLifetimeBehaviourReceiveDamageCount FindBySkillAbnormalLifetimeBehaviourId(int key) { return FindUniqueCore(data, primaryIndexSelector, Comparer<int>.Default, key); }

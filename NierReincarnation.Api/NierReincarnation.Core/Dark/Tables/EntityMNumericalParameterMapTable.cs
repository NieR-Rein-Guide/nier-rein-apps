...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMNumericalParameterMapTable : TableBase<EntityMNumericalParameterMap>
    {
        ...
        public EntityMNumericalParameterMap FindByNumericalParameterMapIdAndParameterKey(ValueTuple<int, int> key) { return FindUniqueCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, key); }

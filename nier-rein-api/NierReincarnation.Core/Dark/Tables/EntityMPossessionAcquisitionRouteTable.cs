...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMPossessionAcquisitionRouteTable : TableBase<EntityMPossessionAcquisitionRoute>
    {
        ...
        public RangeView<EntityMPossessionAcquisitionRoute> FindRangeByPossessionTypeAndPossessionIdAndSortOrder(ValueTuple<PossessionType, int, int> min, ValueTuple<PossessionType, int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(PossessionType, int,int)>.Default, min, max, ascendant); }

...
namespace NierReincarnation.Core.Dark
{
    ...
    public class EntityMCharacterDisplaySwitch
    {
        ...
        public int NameCharacterTextId { get; set; } // 0x14

        [Key(2)] // RVA: 0x1DDAF28 Offset: 0x1DDAF28 VA: 0x1DDAF28
        public int DefaultCostumeId { get; set; } // 0x18

        [Key(3)] // RVA: 0x1DDAF3C Offset: 0x1DDAF3C VA: 0x1DDAF3C
        public int DefaultWeaponId { get; set; } // 0x1C
        ...
        public int CharacterAssetId { get; set; } // 0x24
    }
}

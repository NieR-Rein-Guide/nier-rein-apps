...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMCharacterBoardAbilityMaxLevelTable : TableBase<EntityMCharacterBoardAbilityMaxLevel>
    {
        ...
        public EntityMCharacterBoardAbilityMaxLevel FindByCharacterIdAndAbilityId(ValueTuple<int, int> key) { return FindUniqueCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, key); }

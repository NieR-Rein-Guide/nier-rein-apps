...
{
    internal class ClearAllMapItemsDialog : Modal
    {
        ...
        {
            if (await CooldownHelper.IsOnCooldown()) return;
        ...
        private static string GetItemText((PossessionType, int) reward)
        {

...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMCharacterVoiceUnlockConditionTable : TableBase<EntityMCharacterVoiceUnlockCondition>
    {
        ...
        public EntityMCharacterVoiceUnlockCondition FindByCharacterIdAndSortOrder(ValueTuple<int, int> key) { return FindUniqueCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, key); }

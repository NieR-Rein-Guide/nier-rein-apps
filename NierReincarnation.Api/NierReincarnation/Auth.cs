...
{
    private static readonly HttpClient _client = new(new HttpClientHandler { AllowAutoRedirect = false });
    private static readonly IDictionary<string, string> _cookies = new Dictionary<string, string>();

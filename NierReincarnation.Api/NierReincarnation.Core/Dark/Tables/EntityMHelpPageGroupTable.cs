...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMHelpPageGroupTable : TableBase<EntityMHelpPageGroup>
    {
        ...
        public RangeView<EntityMHelpPageGroup> FindRangeByHelpPageGroupIdAndSortOrder(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMStainedGlassStatusUpTargetGroupTable : TableBase<EntityMStainedGlassStatusUpTargetGroup>
    {
        ...
        public RangeView<EntityMStainedGlassStatusUpTargetGroup> FindByStainedGlassStatusUpTargetGroupId(int key) { return FindManyCore(data, secondaryIndexSelector, Comparer<int>.Default, key); }

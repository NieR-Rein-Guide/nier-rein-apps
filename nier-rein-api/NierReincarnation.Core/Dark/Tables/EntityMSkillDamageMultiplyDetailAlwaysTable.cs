...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMSkillDamageMultiplyDetailAlwaysTable : TableBase<EntityMSkillDamageMultiplyDetailAlways>
    {
        ...
        public EntityMSkillDamageMultiplyDetailAlways FindBySkillDamageMultiplyDetailId(int key) { return FindUniqueCore(data, primaryIndexSelector, Comparer<int>.Default, key); }

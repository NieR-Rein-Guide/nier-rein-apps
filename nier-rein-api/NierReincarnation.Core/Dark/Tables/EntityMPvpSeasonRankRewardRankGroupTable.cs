...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMPvpSeasonRankRewardRankGroupTable : TableBase<EntityMPvpSeasonRankRewardRankGroup>
    {
        ...
        public RangeView<EntityMPvpSeasonRankRewardRankGroup> FindRangeByPvpSeasonRankRewardRankGroupIdAndRankLowerLimit(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

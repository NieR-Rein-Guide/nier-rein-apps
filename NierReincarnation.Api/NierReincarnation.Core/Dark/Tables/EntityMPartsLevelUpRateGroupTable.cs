...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMPartsLevelUpRateGroupTable : TableBase<EntityMPartsLevelUpRateGroup>
    {
        ...
        public EntityMPartsLevelUpRateGroup FindByPartsLevelUpRateGroupIdAndLevelLowerLimit(ValueTuple<int, int> key) { return FindUniqueCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, key); }

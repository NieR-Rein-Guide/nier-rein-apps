...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMSkillBehaviourActionShortenActiveSkillCooltimeTable : TableBase<EntityMSkillBehaviourActionShortenActiveSkillCooltime>
    {
        ...
        public EntityMSkillBehaviourActionShortenActiveSkillCooltime FindBySkillBehaviourActionId(int key) { return FindUniqueCore(data, primaryIndexSelector, Comparer<int>.Default, key); }

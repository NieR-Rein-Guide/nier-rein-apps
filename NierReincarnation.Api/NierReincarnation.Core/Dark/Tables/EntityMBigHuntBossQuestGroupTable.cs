...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMBigHuntBossQuestGroupTable : TableBase<EntityMBigHuntBossQuestGroup>
    {
        ...
        public RangeView<EntityMBigHuntBossQuestGroup> FindRangeByBigHuntBossQuestGroupIdAndSortOrder(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

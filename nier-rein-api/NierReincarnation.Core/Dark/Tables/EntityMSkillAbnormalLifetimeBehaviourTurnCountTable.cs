...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMSkillAbnormalLifetimeBehaviourTurnCountTable : TableBase<EntityMSkillAbnormalLifetimeBehaviourTurnCount>
    {
        ...
        public EntityMSkillAbnormalLifetimeBehaviourTurnCount FindBySkillAbnormalLifetimeBehaviourId(int key) { return FindUniqueCore(data, primaryIndexSelector, Comparer<int>.Default, key); }

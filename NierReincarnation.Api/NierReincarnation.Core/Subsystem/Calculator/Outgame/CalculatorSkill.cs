...
namespace NierReincarnation.Core.Subsystem.Calculator.Outgame
{
    public static class CalculatorSkill
    {
        ...
        private static int kWeaponSkillCooltimeSecondConvertValue = 30; // 0x8
        private static readonly int kCooltimeGaugeRiseSpeedALowerValue = 1500; // 0xC
        private static readonly int kCooltimeGaugeRiseSpeedBLowerValue = 1300; // 0x10
        private static readonly int kCooltimeGaugeRiseSpeedCLowerValue = 1000; // 0x14
        private static readonly int kCooltimeGaugeRiseSpeedDLowerValue = 700; // 0x18
        private static readonly int kInvalidSkillId = 0; // 0x1C
        private static readonly int kInvalidSkillDetailId = 0; // 0x20

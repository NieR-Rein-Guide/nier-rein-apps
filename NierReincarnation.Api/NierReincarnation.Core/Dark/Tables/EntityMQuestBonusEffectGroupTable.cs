...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMQuestBonusEffectGroupTable : TableBase<EntityMQuestBonusEffectGroup>
    {
        ...
        public RangeView<EntityMQuestBonusEffectGroup> FindRangeByQuestBonusEffectGroupIdAndSortOrder(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

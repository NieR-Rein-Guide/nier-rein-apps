...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMCharacterBoardEffectTargetGroupTable : TableBase<EntityMCharacterBoardEffectTargetGroup>
    {
        ...
        public RangeView<EntityMCharacterBoardEffectTargetGroup> FindRangeByCharacterBoardEffectTargetGroupIdAndGroupIndex(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

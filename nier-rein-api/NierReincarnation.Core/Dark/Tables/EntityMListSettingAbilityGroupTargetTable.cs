...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMListSettingAbilityGroupTargetTable : TableBase<EntityMListSettingAbilityGroupTarget>
    {
        ...
        public RangeView<EntityMListSettingAbilityGroupTarget> FindByListSettingAbilityGroupTargetId(int key) { return FindManyCore(data, secondaryIndexSelector, Comparer<int>.Default, key); }

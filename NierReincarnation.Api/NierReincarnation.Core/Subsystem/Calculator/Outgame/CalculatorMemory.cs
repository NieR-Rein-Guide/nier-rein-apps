...
{
    private static readonly int kInvalidMemoryId;
    public static readonly int BonusStatusMaxLevelDummy = -1;
    public static readonly int kMinBonusSetCount = 2;
    public static readonly int kMaxBonusSetCount = 3;

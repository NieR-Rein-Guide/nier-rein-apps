...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMEnhanceCampaignTargetGroupTable : TableBase<EntityMEnhanceCampaignTargetGroup>
    {
        ...
        public RangeView<EntityMEnhanceCampaignTargetGroup> FindRangeByEnhanceCampaignTargetGroupIdAndEnhanceCampaignTargetIndex(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

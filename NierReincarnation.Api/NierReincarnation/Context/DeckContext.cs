...
public class DeckContext : BaseContext
{
    ...
    private static UpdateNameRequest CreateUpdateNameRequest(int userDeckNumber, DeckType deckType, string name)
    {
    ...
    private static RemoveDeckRequest CreateRemoveDeckRequest(int userDeckNumber, DeckType deckType)
    {
    ...
    private static DeckCharacter CreateDeckCharacter(DataDeckActorInfo actor)
    {

...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMBattleBgmSetGroupTable : TableBase<EntityMBattleBgmSetGroup>
    {
        ...
        public RangeView<EntityMBattleBgmSetGroup> FindRangeByBgmSetGroupIdAndBgmSetGroupIndex(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

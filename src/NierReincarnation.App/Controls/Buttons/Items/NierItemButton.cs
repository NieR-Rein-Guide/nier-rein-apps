...
{
    internal abstract class NierItemButton : Component
    {
        ...
        private static FontResource HintFont => Resources.FontResources.FotRodin(11);
        ...
        private static void DrawSelectionOverlay(Rectangle contentRect, bool isHovered, bool isSelected)
        {
        ...
        private static void DrawBonusIcon(Rectangle contentRect)
        {

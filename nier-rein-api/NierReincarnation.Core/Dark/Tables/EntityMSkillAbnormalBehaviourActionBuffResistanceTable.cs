...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMSkillAbnormalBehaviourActionBuffResistanceTable : TableBase<EntityMSkillAbnormalBehaviourActionBuffResistance>
    {
        ...
        public EntityMSkillAbnormalBehaviourActionBuffResistance FindBySkillAbnormalBehaviourActionId(int key) { return FindUniqueCore(data, primaryIndexSelector, Comparer<int>.Default, key); }

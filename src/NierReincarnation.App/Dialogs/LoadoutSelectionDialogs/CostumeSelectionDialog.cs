...
{
    internal class CostumeSelectionDialog : FilterItemDialog<DataOutgameCostumeInfo>
    {
        ...
        private static bool IsValidFilter(DataOutgameCostumeInfo weaponInfo, IList<WeaponType> weaponFilter, IList<RarityType> rarityFilter)
        {

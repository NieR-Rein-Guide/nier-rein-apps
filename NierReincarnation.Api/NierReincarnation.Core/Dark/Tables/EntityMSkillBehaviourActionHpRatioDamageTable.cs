...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMSkillBehaviourActionHpRatioDamageTable : TableBase<EntityMSkillBehaviourActionHpRatioDamage>
    {
        ...
        public EntityMSkillBehaviourActionHpRatioDamage FindBySkillBehaviourActionId(int key) { return FindUniqueCore(data, primaryIndexSelector, Comparer<int>.Default, key); }

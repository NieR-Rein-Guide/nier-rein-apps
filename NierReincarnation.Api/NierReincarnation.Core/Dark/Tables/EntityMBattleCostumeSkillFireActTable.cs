...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMBattleCostumeSkillFireActTable : TableBase<EntityMBattleCostumeSkillFireAct>
    {
        ...
        public bool TryFindByCostumeId(int key, out EntityMBattleCostumeSkillFireAct result) { return TryFindUniqueCore(data, primaryIndexSelector, Comparer<int>.Default, key, out result); }

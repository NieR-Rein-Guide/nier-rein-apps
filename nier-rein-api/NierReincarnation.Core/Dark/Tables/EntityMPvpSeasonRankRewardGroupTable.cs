...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMPvpSeasonRankRewardGroupTable : TableBase<EntityMPvpSeasonRankRewardGroup>
    {
        ...
        public RangeView<EntityMPvpSeasonRankRewardGroup> FindRangeByPvpSeasonRankRewardGroupIdAndPvpRewardId(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

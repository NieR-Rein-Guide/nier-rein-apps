...
{
    internal class NierItemRemoveButton : Component
    {
        ...
        private static (bool, bool) AddButtonStub(Rectangle contentRect)
        {
        ...
        private static void RemoveButtonStub()
        {
            ImGuiNET.ImGui.PopStyleColor(3);
        }

        private static void DrawBorders(Rectangle contentRect)
        {
        ...
        private static void DrawRemoveText(Rectangle contentRect)
        {

...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMBattleEventReceiverBehaviourHudActSequenceTable : TableBase<EntityMBattleEventReceiverBehaviourHudActSequence>
    {
        ...
        public EntityMBattleEventReceiverBehaviourHudActSequence FindByBattleEventReceiverBehaviourId(int key) { return FindUniqueCore(data, primaryIndexSelector, Comparer<int>.Default, key); }

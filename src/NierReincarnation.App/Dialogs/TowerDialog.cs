...
{
    internal class TowerDialog : Modal
    {
        ...
        private readonly NierButton clearButton;

        private readonly ComboBox<DataDeckInfo> decks;
        private readonly List missionList;
        ...
        private void BattleContext_BeforeFinishWave(object sender, BeforeFinishWaveEventArgs e)
        {
        ...
        private static void InitializeDecks(ComboBox<DataDeckInfo> decks)
        {
            decks.Items.Clear();
        ...
        private static void UpdateMissionList(List missionList, EventQuestData quest)
        {

...
{
    internal class LimitContentBundleButton : BaseNierButton
    {
        ...
        private void DrawContent(Rectangle contentRect, bool isActive)
        {
            ...
            Vector2 progressBarSize = new(200, ProgressBarHeight_);
            Vector2 progressBarSizeFilled = new(200f / (Bundle?.QuestCount ?? 1) * (Bundle?.QuestClearCount ?? 0), ProgressBarHeight_);

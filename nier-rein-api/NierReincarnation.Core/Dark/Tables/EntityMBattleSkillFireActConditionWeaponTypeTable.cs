...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMBattleSkillFireActConditionWeaponTypeTable : TableBase<EntityMBattleSkillFireActConditionWeaponType>
    {
        ...
        public bool TryFindByBattleSkillFireActConditionId(int key, out EntityMBattleSkillFireActConditionWeaponType result) { return TryFindUniqueCore(data, primaryIndexSelector, Comparer<int>.Default, key, out result); }

...
public static class DarkUserDataDatabaseBuilderAppendHelper
{
    ...
    static DarkUserDataDatabaseBuilderAppendHelper()
    {
        parsers = new Dictionary<string, Func<IEnumerable<object>, IEnumerable<object>>>
        {
            ...
            ["EntityIUserDeckLimitContentDeletedCharacter"] = records => records.Select(r => ((JObject)r).ToObject<EntityIUserDeckLimitContentDeletedCharacter>()),
        ...
        appenders = new Dictionary<string, Action<DarkUserDatabaseBuilder, IEnumerable<object>>>
        {
            ...
            ["EntityIUserDeckLimitContentDeletedCharacter"] = (builder, records) => builder.Append(records.Cast<EntityIUserDeckLimitContentDeletedCharacter>()),
        ...
        differs = new Dictionary<string, Action<DarkUserMemoryDatabase, object, bool>>
        {
            ...
            ["EntityIUserDeckLimitContentDeletedCharacter"] = (db, record, mode) => ApplyData(mode, (EntityIUserDeckLimitContentDeletedCharacter)record, db.EntityIUserDeckLimitContentDeletedCharacterTable, r => db.EntityIUserDeckLimitContentDeletedCharacterTable.All.FirstOrDefault(x => x.UserId == r.UserId && x.UserDeckNumber == r.UserDeckNumber && x.UserDeckCharacterNumber == r.UserDeckCharacterNumber)),

...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMBattleBigHuntDamageThresholdGroupTable : TableBase<EntityMBattleBigHuntDamageThresholdGroup>
    {
        ...
        public RangeView<EntityMBattleBigHuntDamageThresholdGroup> FindRangeByKnockDownDamageThresholdGroupIdAndKnockDownDamageThresholdGroupOrder(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

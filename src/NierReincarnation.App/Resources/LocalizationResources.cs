...
namespace NierReincarnation.App.Resources
{
    ...
    {
        private const string ResourceName_ = "NierReincarnation.App.Resources.Localizations.{0}.json";
        ...
        {
            return Application.Language switch
            {
                Language.English => FromResource("en"),
                _ => throw new InvalidOperationException($"Unsupported language {Application.Language}."),
            };
        }

...
{
    internal class WeaponSelectionDialog : FilterItemDialog<DataWeaponInfo>
    {
        ...
        private readonly ComboBox<QuestItem> questSelection;
        ...
        private static bool IsValidFilter(DataWeaponInfo weaponInfo, IList<AttributeType> attributeFilter, IList<WeaponType> weaponFilter, IList<RarityType> rarityFilter)
        {
        ...
        {
            public static readonly QuestItem Empty = new();

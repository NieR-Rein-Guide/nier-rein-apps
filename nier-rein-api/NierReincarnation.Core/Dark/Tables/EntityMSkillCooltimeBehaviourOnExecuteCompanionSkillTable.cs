...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMSkillCooltimeBehaviourOnExecuteCompanionSkillTable : TableBase<EntityMSkillCooltimeBehaviourOnExecuteCompanionSkill>
    {
        ...
        public bool TryFindBySkillCooltimeBehaviourActionId(int key, out EntityMSkillCooltimeBehaviourOnExecuteCompanionSkill result) { return TryFindUniqueCore(data, primaryIndexSelector, Comparer<int>.Default, key, out result); }

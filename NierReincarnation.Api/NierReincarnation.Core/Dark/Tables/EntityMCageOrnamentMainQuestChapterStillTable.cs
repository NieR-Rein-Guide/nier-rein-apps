...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMCageOrnamentMainQuestChapterStillTable : TableBase<EntityMCageOrnamentMainQuestChapterStill>
    {
        ...
        public EntityMCageOrnamentMainQuestChapterStill FindByMainQuestChapterId(int key) { return FindUniqueCore(data, primaryIndexSelector, Comparer<int>.Default, key); }

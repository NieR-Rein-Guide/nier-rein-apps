...
namespace NierReincarnation.Core.Dark.Tables
{
    public class EntityMSkillDamageMultiplyAbnormalAttachedValueGroupTable : TableBase<EntityMSkillDamageMultiplyAbnormalAttachedValueGroup>
    {
        ...
        public RangeView<EntityMSkillDamageMultiplyAbnormalAttachedValueGroup> FindRangeBySkillDamageMultiplyAbnormalAttachedValueGroupIdAndSkillDamageMultiplyAbnormalAttachedValueGroupIndex(ValueTuple<int, int> min, ValueTuple<int, int> max, bool ascendant = true) { return FindUniqueRangeCore(data, primaryIndexSelector, Comparer<(int,int)>.Default, min, max, ascendant); }

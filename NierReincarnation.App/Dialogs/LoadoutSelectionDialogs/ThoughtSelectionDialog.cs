...
{
    internal class ThoughtSelectionDialog : FilterItemDialog<DataOutgameThoughtInfo>
    {
        ...
        private static bool IsValidFilter(DataOutgameThoughtInfo thought, IList<RarityType> rarityFilter)
        {

...
namespace NierReincarnation.Core.Dark
{
    ...
    public class EntityMPowerReferenceStatusGroup
    {
        ...
        public int PowerReferenceStatusGroupId { get; set; } // 0x10

        [Key(1)] // RVA: 0x1DE0DF0 Offset: 0x1DE0DF0 VA: 0x1DE0DF0
        public StatusKindType ReferenceStatusType { get; set; } // 0x14
        ...
        public int CoefficientValuePermil { get; set; } // 0x1C
    }
}

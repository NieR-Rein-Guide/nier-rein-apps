...
{
    internal class NierButton : BaseNierButton
    {
        ...
        private static void ApplyStyles(bool isHovered, bool isActive, bool isEnabled, FontResource font)
        {
            if (font != null)
                ImGuiNET.ImGui.PushFont((ImFontPtr)font);
        ...
        private static void RemoveStyles(bool isHovered, bool isActive, bool isEnabled, FontResource font)
        {
            if (font != null)
                ImGuiNET.ImGui.PopFont();
